        ...
        void Update() {
            ...
            if (_animateRotation) {
                if (rotationType == RotationType.WorldAxis) {
                    ...
                    this.transform.Rotate(rotationSpeedsInDegreePerSecond * Time.deltaTime/2, Space.World);
                } else {
                    this.transform.Rotate(rotationSpeedsInDegreePerSecond * Time.deltaTime/2, Space.Self);
                }
            }
        }
